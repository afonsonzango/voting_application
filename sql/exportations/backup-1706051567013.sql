...
CREATE TABLE `battles` (
  ...
  `key_relations_id` int DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `key_relations_id` (`key_relations_id`),
  CONSTRAINT `battles_ibfk_1` FOREIGN KEY (`key_relations_id`) REFERENCES `key_relations` (`id`)
...
INSERT INTO `battles` VALUES (1,NULL,38,39,16,17,0,0,1);
...
-- Dump completed on 2024-01-23 23:12:47
